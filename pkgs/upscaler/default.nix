# https://github.com/NixOS/nixpkgs/blob/nixos-25.11/pkgs/by-name/up/upscaler/package.nix
# + call with llvmpipe (CPU only) to circumvent GPU issues on certain Intel GPUs (HD 620, UHD pre‑Arc)
